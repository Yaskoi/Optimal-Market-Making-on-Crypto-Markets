...
* BTC/USDT 1-second OHLCV candles sourced from the [Binance Data Portal](https://data.binance.vision/?prefix=data/spot/monthly/klines/BTCUSDT/1s).
* ETH/USDT 1-second OHLCV candles sourced from the [Binance Data Portal](https://data.binance.vision/?prefix=data/spot/monthly/klines/ETHUSDT/1s).
